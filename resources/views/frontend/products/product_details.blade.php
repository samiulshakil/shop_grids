                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ asset($product->product_thumbnail) }}" id="current" alt="#">
                                </div>
                                <div class="images">
                                    <img src="{{ asset($product->product_thumbnail) }}" class="img" alt="#">
                                    <img src="{{ asset($product->image_two) }}" class="img" alt="#">
                                    <img src="{{ asset($product->image_three) }}" class="img" alt="#">
                                    <img src="{{ asset($product->image_one) }}" class="img" alt="#">
                                    <img src="{{ asset($product->image_three) }}" class="img" alt="#">
                                </div>
                            </main>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)">
                                    {{ $product->product_tags }}</a></p>
                            <h3 class="price">
                                ${{ $product->discount_price }}<span>${{ $product->selling_price }}</span></h3>
                                    ...
                                    <div class="form-group color-option">
                                        ...
                                        <select class="form-control" id="size">
                                            @forelse ($sizes as $size)
                                                <option class="form-control" value="{{ $size }}">
                                                    {{ $size }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="size">
                                            @forelse ($colors as $color)
                                                <option class="form-control" value="{{ $color }}}">
                                                    {{ $color }}</option>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="wish-button">
                                            <form action="" method="POST">
                                                @csrf
                                                <button class="btn addwish" id="addwish"><i class="lni lni-heart"></i>
                                                    To
                                                    Wishlist</button>
                                            </form>
                                        </div>
            ...
            $('body').on('click', '#addwish', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.wish_numbers').html(data.wishcount);
                    },
