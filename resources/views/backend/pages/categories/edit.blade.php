                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body"> 
                            ...
                            <div class="form-group">
                              ...
                              @error('category_name') is-invalid @enderror" autofocus>
                            </div>
                          @error('category_name')
                              <p>
                          ...
                          <div class="form-group">
                            ...
                            data-allowed-file-extensions="jpg jpeg png svg webp gif" data-default-file="{{asset($category->category_image)}}"
                            class="dropify form-control @error('category_image') is-invalid @enderror" name="category_image" id="category_image">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" name="category_status" class="custom-control-input"
                                 id="category_status" @if ($category->category_status == true)
                                 checked
                                @endif>
