                    ...
                    <div class="main-card mb-3 card">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror" name="type" id="type">
                                ...
                                <option value="regular" {{$coupon->type == 'regular' ? 'selected' : '' }}>Regular</option>
                            </select>
                        </div>
                        @error('type')
                        <p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="value" value="{{ $coupon->value }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="{{$coupon->expire}}"
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" name="status" {{$coupon->status == 1 ? 'checked' : ''}} class="custom-control-input" id="status">
