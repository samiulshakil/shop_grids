    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title">Social Media Edit</h5>
                    </p>
                </div>
            </div>
            <form action="{{ route('admin.settings.socialmedias.update', $social->id) }}" method="post">
                @csrf
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Social Media Name"
                                class="form-control @error('name') is-invalid @enderror" value="{{ $social->name }}"
                                required>
                        </div>
                        @error('name')
                            <p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="url" name="url" placeholder="Social Media URL"
                                class="form-control @error('url') is-invalid @enderror" value="{{ $social->url }}"
                                required>
                        </div>
                        @error('url')
                            <p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="icon" name="icon" placeholder="Social Media icon"
                                class="form-control @error('icon') is-invalid @enderror" value="{{ $social->icon }}"
                                required>
                        </div>
                        @error('icon')
                            <p>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <div class="custom-control custom-switch">
                                <input {{ $social->status == 1 ? 'checked' : '' }} type="checkbox" name="status"
                                    class="custom-control-input mt-2" id="status">
