                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_mailer" id="mail_mailer"
                                        ...
                                        value="{{ setting('mail_mailer') ?? old('mail_mailer') }}" placeholder="Mailer">
                                    @error('mail_mailer')
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="mail_encryption">Mail Encryption <code>{ key: mail_encryption
                                            }</code></label>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_host" id="mail_host"
                                        ...
                                        value="{{ setting('mail_host') ?? old('mail_host') }}" placeholder="Mail Host">
                                    @error('mail_host')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_port" id="mail_port"
                                        ...
                                        value="{{ setting('mail_port') ?? old('mail_port') }}" placeholder="Mail Port">
                                    @error('mail_port')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mail_username" id="mail_username"
                                ...
                                value="{{ setting('mail_username') ?? old('mail_username') }}" placeholder="Username">
                            @error('mail_username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="mail_password" id="mail_password"
                                ...
                                value="{{ setting('mail_password') ?? old('mail_password') }}" placeholder="Password">
                            @error('mail_password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mail_from_name" id="mail_from_name"
                                ...
                                value="{{ setting('mail_from_name') ?? old('mail_from_name') }}" placeholder="From Name">
