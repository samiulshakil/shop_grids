                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="banner_image" data-show-errors="true" data-errors-position="outside"
                                ...
                                id="banner_image" data-default-file="{{ asset($banner->banner_image) }}">
                        </div>
                        @error('banner_image')
                            <p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="banner_image_two" data-show-errors="true" data-errors-position="outside"
                                ...
                                data-default-file="{{ asset($banner->banner_image_two) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="banner_sub_title" name="banner_sub_title" placeholder="Sub Title"
                                ...
                                value="{{ $banner->banner_sub_title }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="banner_description" name="banner_description" placeholder="Description"
                                ...
                                value="{{ $banner->banner_description }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="banner_price" name="banner_price" placeholder="Price"
                                ...
                                value="{{ $banner->banner_price }}" required>
                        </div>
                        @error('banner_price')
                            <p>
                                <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="banner_button_text" name="banner_button_text" placeholder="Button Text"
                                ...
                                value="{{ $banner->banner_button_text }}" required>
                        </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <div class="custom-control custom-switch">
                                <input {{ $banner->status == 1 ? 'checked' : '' }} type="checkbox" name="status"
