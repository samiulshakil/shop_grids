                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify form-control @error('site_logo') is-invalid @enderror"
                                name="site_logo"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify form-control @error('site_favicon') is-invalid @enderror"
                                name="site_favicon"
