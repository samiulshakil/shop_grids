                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img width="40" class="rounded-circle"
                                        src="{{ $product->product_thumbnail != null ? asset($product->product_thumbnail) : 'https://via.placeholder.com/200x200'}}" alt="Avatar">
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin.products.edit', $product->product_slug)}}" class="btn btn-info btn-sm">
                                    ...
                                    <form id="delete-form-{{$product->id}}" method="post" action="{{ route('admin.products.destroy', $product->id) }}">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
