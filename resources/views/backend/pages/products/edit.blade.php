                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $product->product_code }}" id="product_code" name="product_code" placeholder="Product Code" class="form-control 
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $product->product_qty }}" id="product_qty" name="product_qty" placeholder="Product Quantity" class="form-control 
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $product->product_tags }}" data-role="tagsinput" id="product_tags" name="product_tags" placeholder="Product Tags" class="form-control 
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $product->product_size }}" data-role="tagsinput" id="product_size" name="product_size" placeholder="Product Size" class="form-control 
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $product->product_color }}" data-role="tagsinput" id="product_color" name="product_color" placeholder="Product Color" class="form-control 
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $product->selling_price }}" id="selling_price" name="selling_price" placeholder="Selling Price" class="form-control 
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $product->discount_price }}" type="number" id="discount_price" name="discount_price" placeholder="Discount Price" class="form-control 
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        data-allowed-file-extensions="jpg jpeg png svg webp gif" class="dropify form-control
                                         ...
                                         data-default-file="{{asset($product->product_thumbnail)}}">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        @error('long_description') is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        @error('key_features') is-invalid @enderror">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        @error('specifications') is-invalid @enderror">
                            ...
                            <div class="form-group mt-4">
                                <div class="custom-control custom-switch">
                                    ...
                                    class="custom-control-input mt-2" id="product_status">
