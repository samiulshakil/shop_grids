    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('admin.blogs.create') }}" class="mr-3 btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($blogs as $key => $blog)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $blog->category->category_name }}</td>
                                    <td class="text-center">{{ $blog->author }}</td>
                                    <td class="text-center">
                                        <img width="40" class="rounded-circle" src="{{ asset($blog->image) }}"
                                            alt="Avatar">
                                    </td>
                                    <td class="text-center">
                                        @if ($blog->status == true)
