                ...
                <div class="col-md-4">
                    <div class="main-card mb-3 card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify form-control" name="image" id="image">
                        </div>
                        @error('image')
                        <p>
                            <span class="text-danger" role="alert">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="meta_description" name="meta_description" placeholder="Meta Description" class="form-control 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="meta_keyword" name="meta_keyword" placeholder="Meta Keyword" class="form-control 
